...
/**
 * Servlet que maneja las solicitudes de un menú de usuario
 * tiene la funcionalidad de mostrar nombre de usuario, saldo y además redirigir a páginas de deposito y retiro
 */
...
public class MenuUsuarioController extends HttpServlet{
	...
	/**
     * maneja las solicitudes post del menú
     * Obtiene el correo del usuario de la sesión, recupera su saldo y nombre,
     * y redirige a las páginas de deposito y retiro saldo
     * 
