...
/**
 * Servlet que maneja las solicitudes de depósito en cuenta bancaria
 * Proporciona funcionalidad para realizar un depósito y actualizar saldo en la bd
 * 
 */
...
public class DepositarController extends HttpServlet{
	...
	/**
     * maneja las solicitudes post para realizar un depósito bancario
     * obtiene el monto del depósito y el correo del usuario de la sesión, valida un depósito y actualiza el saldo 
     * en la bd
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (correo != null) {
        	...
        	if (saldoActual >= monto && monto > 0) {
                ...
                // si no hay suficiente saldo o monto es menor a 0, redirige a página de error deposito
