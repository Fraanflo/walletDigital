...
/**
 * Servlet que maneja las solicitudes de un login de usuario
 * tiene la funcionalidad de autenticar a un usuario y de gestionar la sesión
 */
...
public class InicioSesionController extends HttpServlet {
	 private static final long serialVersionUID = 1L;
	    ...
	    /**
	     * maneja las solicitudes post para el login de un usuario.
	     * autentica al usuario utilizando su correo y clave. si la autenticacion es exitosa, establece la sesión del usuario y redirige al menú principal. 
	     * Si la autenticación falla, redirige a la pagina de inicio de sesión con msj de error
	     * 
